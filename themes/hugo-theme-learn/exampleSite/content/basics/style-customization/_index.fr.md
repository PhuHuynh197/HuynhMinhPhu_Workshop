...
Si votre favicon est un png, déposez votre image dans votre dossier local `static/HuynhMinhPhu_Workshop/images/` et nommez le `favicon.png`
...
```html
<link rel="shortcut icon" href="/HuynhMinhPhu_Workshop/images/favicon.png" type="image/x-icon" />
```
...
![Variante rouge](/en/basics/style-customization/HuynhMinhPhu_Workshop/images/red-variant.png?width=60pc)
...
![Variante bleue](/en/basics/style-customization/HuynhMinhPhu_Workshop/images/blue-variant.png?width=60pc)
...
![Variante verte](/en/basics/style-customization/HuynhMinhPhu_Workshop/images/green-variant.png?width=60pc)
